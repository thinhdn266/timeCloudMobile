...
//			menuLeft.setViewType(mAdapter.getItemViewType(position));
			menuLeft.setViewType(0);
			SwipeMenu menuRight = new SwipeMenu(mContext);
//			menuRight.setViewType(mAdapter.getItemViewType(position));
			menuRight.setViewType(1);
			createRightMenu(menuRight);
			createLeftMenu(menuLeft);
			SwipeMenuView menuLeftView = new SwipeMenuView(menuLeft, (SwipeMenuListView) parent);
			SwipeMenuView menuRightView = new SwipeMenuView(menuRight, (SwipeMenuListView) parent);
